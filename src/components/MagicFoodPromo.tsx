...
const MENU = [
  {
    ...
    items: [
      ...
      { name: { SQ: "File Pule Porcion", EN: "Chicken Fillet Plate", MK: "Порција пилешко филе" }, price: "200/300" },
  ...
  },
  {
    ...
    image: salad,
    items: [
      { name: { SQ: "Sallat Shope", EN: "Shopska Salad", MK: "Шопска салата" }, price: "140" },
  ...
  },
  {
    ...
    image: drinks,
    items: [
      { name: { SQ: "Coca Cola", EN: "Coca Cola", MK: "Кока Кола" }, price: "70/80" },
      { name: { SQ: "Fanta", EN: "Fanta", MK: "Фанта" }, price: "70/80" },
      { name: { SQ: "Fanta Tropikal", EN: "Fanta Tropical", MK: "Фанта Тропик" }, price: "70/80" },
      { name: { SQ: "Sprite", EN: "Sprite", MK: "Спрајт" }, price: "70/80" },
      { name: { SQ: "Schweppes", EN: "Schweppes", MK: "Швепс" }, price: "70/80" },
  ...
  return (
    <main className="font-body bg-background text-foreground">
      ...
      <footer className="w-full py-4 text-center" style={{ background: "#0a0a0a" }}>
        <p className="text-white/60 text-[10px] uppercase tracking-widest">Created by Besnik.Az</p>
      </footer>
    </main>
  );
}
