...
const MENU = [
  ...
  },
  {
    ...
    image: drinks,
    items: [
      { name: { SQ: "Coca Cola", EN: "Coca Cola", MK: "Кока Кола" }, price: "60/80" },
      { name: { SQ: "Fanta", EN: "Fanta", MK: "Фанта" }, price: "60/80" },
      { name: { SQ: "Fanta Tropikal", EN: "Fanta Tropical", MK: "Фанта Тропик" }, price: "60/80" },
      { name: { SQ: "Sprite", EN: "Sprite", MK: "Спрајт" }, price: "60/80" },
      { name: { SQ: "Schweppes", EN: "Schweppes", MK: "Швепс" }, price: "60/80" },
